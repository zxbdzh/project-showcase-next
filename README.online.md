...
<img src="https://minio.zxbdwy.online/picgo/2026/05/783ea8c39721ca1553b11c7c7f2d8680.webp" alt="project-showcase-next" width="72" height="72" />

# project-showcase-next

**全栈作品集 + CMS 后台。** 终端 / 工程美学,端到端类型安全,Next.js 16 RSC + 流式 AI。

<sub>// Live · <a href="https://project.zxbdwy.online">project.zxbdwy.online</a> · Source · <a href="https://github.com/zxbdzh/project-showcase-next">github.com/zxbdzh/project-showcase-next</a></sub>
...
<table>
  <tr>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/e759b2af52a8e1c2ef985e2428df787a.webp" alt="首页 / 终端 Hero" />
      <sub><b>首页 · Hero</b> — 终端窗口 + 能力数据条 + 实时拼装命令</sub>
    </td>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/a79214663dd266367b6491df74cffd67.webp" alt="首页 / 精选作品" />
      <sub><b>首页 · 精选作品</b> — 文件式编号卡片网格</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/6ad47eac29af541c34944cb35b078ea9.webp" alt="首页 / 技术栈" />
      <sub><b>首页 · 技术栈</b> — 等宽 chip 矩阵 · 分组排布</sub>
    </td>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/ec0ebe1b6dd2dfd320f32be63ca7bc14.webp" alt="首页 / AI 分身入口" />
      <sub><b>首页 · AI 分身</b> — 流式 + 多步工具调用聊天入口</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/eecff2eee8ad2735c762bf25b596ebe4.webp" alt="作品列表 / 分类筛选" />
      <sub><b>作品列表</b> — 分类筛选 + 关键字搜索 + 视图模式</sub>
    </td>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/80f89e7da774684ab8142ccb7f2a2076.webp" alt="项目详情 / JSON manifest" />
      <sub><b>项目详情 · Hero</b> — JSON manifest 终端窗口</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/64caaba61bfd7523487586ca373559f8.webp" alt="项目详情 / MDX README" />
      <sub><b>项目详情 · README</b> — MDX 渲染 + 幻灯片预览</sub>
    </td>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/5921e8b4e8fb04c82fbb32eb19a4d456.webp" alt="关于 / Hero" />
      <sub><b>关于 · Hero</b> — 个人介绍 + 社交链接</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/6bed7a7c87284678a06614702ceb864a.webp" alt="关于 / 技能栈" />
      <sub><b>关于 · 技能</b> — 分组技能矩阵</sub>
    </td>
    <td width="50%" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/b6865ecbfa6ce101991244b085ebb8fc.webp" alt="联系" />
      <sub><b>联系</b> — Server Action 表单 · 缺 SMTP 降级日志</sub>
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      <img src="https://minio.zxbdwy.online/picgo/2026/05/bd06d59cb4bc65ea058b0a7511633370.webp" alt="后台登录" width="70%" />
...
- **终端 / 工程美学** — 暖橙琥珀 + 暖灰 stone + JetBrains Mono;方角、克制动效、无霓虹与无限循环。设计规范见 [`docs/design-system.md`](https://github.com/zxbdzh/project-showcase-next/blob/main/docs/design-system.md)。
...
完整变量与注释见 [`.env.example`](https://github.com/zxbdzh/project-showcase-next/blob/main/.env.example)。
...
- 开工前读 [`docs/ROADMAP.md`](https://github.com/zxbdzh/project-showcase-next/blob/main/docs/ROADMAP.md),选**未完成、依赖已满足**的任务。
...
- AI / Auth.js / DB 等所有 Skill 命中场景请主动调用对应 Skill(详见 [`CLAUDE.md`](https://github.com/zxbdzh/project-showcase-next/blob/main/CLAUDE.md))。
